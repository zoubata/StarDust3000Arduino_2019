...
ros::Publisher pub_temp("r1/pilo/time", &temp_msg);
...
if (MyWireLcd.testLine( ) )// if LCD present use it.
{

//&& WireTest( MyWireLcd, LCD_ADDR) don't work
MyWireLcd.begin();
...
{wdt_clr();
    ...
    servo_cmdE.write(130);delay(200);wdt_clr();
    servo_cmdE.write(140);delay(200);
    servo_cmdE.write(150);delay(200); 
    servo_cmdE.write(160);delay(200);wdt_clr();
    ...
    servo_cmdE.write(90);wdt_clr();
    
    delay(600);wdt_clr();
    servo_cmdE.write(160);
    delay(600);wdt_clr();
...
//    servo_cmdF.write(160);delay(200);
 //   servo_cmdF.write(170);delay(200);
  //  servo_cmdF.write(180);delay(200);wdt_clr();
    ...
    servo_cmdF.write(120);delay(200); 
    servo_cmdF.write(130);delay(200);
     servo_cmdE.write(90);delay(200);
        servo_cmdE.write(80);delay(200);
            servo_cmdE.write(70);delay(200);
