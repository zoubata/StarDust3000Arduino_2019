...
void setup() {
	...
	SUPC->BODCORE.bit.ACTION = SUPC_BODVDD_ACTION_RESET | SUPC_BODCORE_HYST
			| SUPC_BODCORE_LEVEL(40);
	SUPC->BODCORE.bit.ENABLE = 1;
	SUPC->BODVDD.bit.ENABLE = 0;
	SUPC->BODVDD.bit.ACTION = SUPC_BODVDD_ACTION_RESET | SUPC_BODVDD_HYST
			| SUPC_BODVDD_LEVEL(7);
...
signed int v=610193/10;
{
cmd1.setPoint(v);cmd2.setPoint(v); cmd3.setPoint(v);
...
cmd1.setPoint(v);cmd2.setPoint(v); cmd3.setPoint(v);
  ...
  cmd1.stop();cmd2.stop();cmd3.stop();
		...
		delay(200);
                v=cmd1.getEncoder()->getSpeed();
                v=cmd2.getEncoder()->getSpeed();
                v=cmd3.getEncoder()->getSpeed();
