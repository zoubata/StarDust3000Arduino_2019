...
#define M7_CA  -1 
#define M7_CB  -1 
#define M7_MP motorBoard.getPin(MOTOR3_P10_PWM)  
#define M7_MM  motorBoard.getPin(MOTOR3_P10_IO) 
#define M7_EN  motorBoard.getPin(MOTOR3_P10_EN) 
...
cmd2.setup(&nh,	M2_TOPIC_PWM,M2_TOPIC_SPEED);
 ...
 cmd3.setRefreshRateUs(10000);
  ...
  cmd5.setPin(M5_CA, M5_CB, M5_MP, M5_MM);
  cmd5.setup();
  cmd5.setup( &nh,	M5_TOPIC_PWM,M5_TOPIC_SPEED);
  
  cmd6.setPin(M6_CA, M6_CB, M6_MP, M6_MM);
  cmd6.setup();
  cmd6.setup( &nh,	M6_TOPIC_PWM,M6_TOPIC_SPEED);
  
  cmd7.setPin(M7_CA, M7_CB, M7_MP, M7_MM);
  cmd7.setup();
